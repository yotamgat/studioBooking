                  ...
                  bookings.map((booking: any) => (
                    <tr key={booking._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        {new Date(booking.createdAt || booking._id).toLocaleDateString('he-IL', {
                          day: '2-digit',
                          month: '2-digit',
                          year: 'numeric',
                        })}
                        <div className="text-xs text-gray-500">
                          {new Date(booking.createdAt || booking._id).toLocaleTimeString('he-IL', {
                            hour: '2-digit',
                            minute: '2-digit',
                          })}
                        </div>
